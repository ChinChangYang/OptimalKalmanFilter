function run_minmin
%RUN_MAX Run the min-min problem
startTime = tic;
close all;
rng(1, 'twister');
solver = 'jadebin';
...
lb = [0.99; 0.0099; 0.99; 0.99; 0.99; 0.0099; 0.99; 0.99];
ub = [1.01; 0.0101; 1.01; 1.01; 1.01; 0.0101; 1.01; 1.01];
[xmin, fmin, out] = ...
...
save(sprintf('minmin_results_by_%s_%s.mat', ...
	solver, ...
