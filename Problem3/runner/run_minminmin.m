function run_minminmin
%RUN_MAX Run the min-min-min problem
startTime = tic;
close all;
rng(1, 'twister');
solver = 'jadebin';
fitfun = 'error_nominal_zeta';
fhandle = @(x) feval(fitfun, x);
D = 9;
maxfunevals = 3e6;
...
lb = [0.99; 0.0099; 0.99; 0.99; 0.99; 0.0099; 0.99; 0.99; 0.7];
ub = [1.01; 0.0101; 1.01; 1.01; 1.01; 0.0101; 1.01; 1.01; 1.3];
[xmin, fmin, out] = ...
...
save(sprintf('minminmin_results_by_%s_%s.mat', ...
	solver, ...
